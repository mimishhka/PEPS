      ...
      <div className="rounded-xl border border-ash bg-white shadow-2xl p-5">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            onClick={accept}
            className="bg-nova text-nordfjord font-mono text-xs uppercase tracking-[0.2em] px-5 py-2.5 transition-colors hover:bg-nova-hover" style={{ borderRadius: "var(--r-m)" }}
          >
            {t("cookies.accept")}
          </button>
          <Link
