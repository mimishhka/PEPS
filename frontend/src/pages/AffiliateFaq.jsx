...
const QA = [
  {
    ...
    fr: {
      ...
      a: [
        ...
        "Mais la commission se gagne commande par commande. Il faut que votre lien ait été cliqué, ou votre code saisi, POUR CETTE COMMANDE-LÀ. Le clic dépose un témoin valable 365 jours : pendant cette période, le même navigateur vous attribue les commandes sans que le client ait à saisir quoi que ce soit.",
        "Concrètement : un client arrivé par votre lien il y a deux ans, qui revient aujourd'hui directement sur le site et commande sans code, ne vous rapporte rien. C'est pourquoi il vaut la peine que vos contacts gardent votre code sous la main — c'est lui qui leur donne le rabais, et vous la commission.",
      ],
    },
    en: {
      ...
      a: [
        ...
        "But a commission is earned order by order. Your link must have been clicked, or your code entered, FOR THAT PARTICULAR ORDER. The click sets a cookie valid for 365 days: during that period the same browser credits orders to you with nothing for the customer to type.",
        "In practice: a customer who arrived through your link two years ago, returning today straight to the site and ordering without a code, earns you nothing. Which is why it pays to make sure your contacts keep your code to hand — it is what gives them the discount, and you the commission.",
      ],
    },
  },
  {
    ...
    fr: {
      ...
      a: [
        ...
        "Il n'y a pas de rattachement durable : une commande passée sans lien ni code ne rapporte à personne. C'est la contrepartie de la règle — vous ne perdez jamais un client acquis, parce qu'aucun client n'est acquis d'avance. Ce qui compte est que votre code soit celui qu'il a sous la main.",
      ],
    },
    en: {
      ...
      a: [
        ...
        "There is no permanent link: an order placed with no link and no code earns nobody anything. That is the other side of the rule — you never lose a customer you had won, because no customer is won in advance. What matters is that yours is the code they have to hand.",
      ],
    },
  },
  {
